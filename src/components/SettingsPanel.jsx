    ...
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/70">
      <div className="bg-gray-900 rounded-2xl p-4 w-[320px]">
        ...
        <div className="mb-4 flex items-center justify-between">
          <span className="text-gray-300 text-sm font-bold">Vibration</span>
          <button
        ...
        {/* Scene Selector */}
        <div className="mb-2">
          <span className="text-gray-300 text-sm font-bold block mb-2">Scene</span>
            ...
            {Object.values(SCENES).map(scene => {
              ...
              return (
                ...
                >
                  ...
                  />
                  {scene.label}
                  {!unlocked && <div className="text-[9px] text-gray-500">Locked</div>}
                </button>
              );
            })}
          </div>
